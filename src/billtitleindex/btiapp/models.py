...
class BillBasic(models.Model):
    ...
    introduced_at = models.DateField(
        verbose_name=_("introduction date"),
        auto_now=False,
        auto_now_add=False,
    )
...
class BillTitles(models.Model):
    ...
    official_title = models.CharField(
        verbose_name=_("official_title"),
        max_length=2000,
        blank=True,
        null=True,
    )
    popular_title = models.CharField(
        verbose_name=_("popular_title"),
        max_length=2000,
        blank=True,
        null=True,
    )
    short_title = models.CharField(
        verbose_name=_("short_title"),
        max_length=2000,
        blank=True,
        null=True,
    )
...
class BillStageTitle(models.Model):
    ...
    is_for_portion = models.BooleanField(
        verbose_name=_("is_for_portion"),
        blank=True,
        null=True,
    )
